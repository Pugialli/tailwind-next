        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="João Paulo" />
              </Input.Root>
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control id="lastName" defaultValue="Pugialli" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="joaopugialli@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              <Input.Control id="role" defaultValue="Analyst" />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a timezone...">
              ...
              />
              <SelectItem value="utc-3" text="Americas São Paulo (UTC−03:00)" />
            </Select>
          </div>
